...
const Explore = () => {
    return (
        <div className='text-white'>
            <div className='text-5xl ml-8 font-semibold tracking-wide pb-2 mt-5'>Explore Our These Amazing Works</div>
            <div className='h-[90vh] w-[full] flex justify-center mt-5'>
